...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.FOREGROUND_SERVICE) != PackageManager.PERMISSION_GRANTED || ActivityCompat.checkSelfPermission(this, Manifest.permission.KILL_BACKGROUND_PROCESSES) != PackageManager.PERMISSION_GRANTED) {
            ...
            Log.i("Permission", "Request permission needed!");

            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                ActivityCompat.requestPermissions(this, new String[]{
                        Manifest.permission.FOREGROUND_SERVICE, Manifest.permission.KILL_BACKGROUND_PROCESSES
                }, Config.REQUEST_PERMISSION_GROUP_CODE);
            }
        }
        ...
        boolean serviceStarted = isServiceRunning(MainActivity.this, AlarmService.class.getName());
